...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        places_checkbox->setObjectName(QString::fromUtf8("places_checkbox"));
        ...
        placenames_checkbox->setObjectName(QString::fromUtf8("placenames_checkbox"));
        ...
        areas_checkbox->setObjectName(QString::fromUtf8("areas_checkbox"));
        areas_checkbox->setChecked(true);

        verticalLayout_2->addWidget(areas_checkbox);

        ways_checkbox = new QCheckBox(layoutWidget);
        ways_checkbox->setObjectName(QString::fromUtf8("ways_checkbox"));
        ways_checkbox->setChecked(true);
        ...
        xroads_checkbox->setObjectName(QString::fromUtf8("xroads_checkbox"));
